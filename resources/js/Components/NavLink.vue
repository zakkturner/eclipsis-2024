...
const classes = computed(() =>
    props.active
        ?
        'inline-flex items-center px-1 pt-1 text-sm font-medium border-b-2 border-transparent  leading-5 text-gray-900 focus:border-eclipsis-gold  transition duration-150 ease-in-out'
        :
